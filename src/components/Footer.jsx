  ...
  return (
    ...
    >
      ...
      >
        <Link
          to="/discover"
          className="btn d-flex flex-column align-items-center gap-1 text-danger fw-bold text-decoration-none"
        ...
        <Link
          to="/matches"
          className="btn d-flex flex-column align-items-center gap-1 text-muted position-relative text-decoration-none"
          style={{ fontSize: "0.7rem" }}
        >
          <i className="bi bi-heart-fill fs-4"></i>
          <span
            className="position-absolute top-1 start-50 translate-middle-x badge rounded-circle bg-warning text-dark fw-bold px-1"
        ...
        <Link
          to="/conversations"
          className="btn d-flex flex-column align-items-center gap-1 text-muted text-decoration-none"
          style={{ fontSize: "0.7rem" }}
        >
